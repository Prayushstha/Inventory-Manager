...
var f = Object.create, p = Object.defineProperty, m = Object.getOwnPropertyDescriptor, h = Object.getOwnPropertyNames, g = Object.getPrototypeOf, _ = Object.prototype.hasOwnProperty, v = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), y = (e, t, n, r) => {
	...
	value: e,
	enumerable: !0
}) : n, e)), x = /* @__PURE__ */ e(import.meta.url), S = /* @__PURE__ */ v(((e) => {
	...
	var c = ee();
	s.prototype.prepare = c.prepare, s.prototype.transaction = te(), s.prototype.pragma = ne(), s.prototype.backup = E(), s.prototype.serialize = D(), s.prototype.function = O(), s.prototype.aggregate = k(), s.prototype.table = A(), s.prototype.loadExtension = c.loadExtension, s.prototype.exec = c.exec, s.prototype.close = c.close, s.prototype.defaultSafeIntegers = c.defaultSafeIntegers, s.prototype.unsafeMode = c.unsafeMode, s.prototype[i.inspect] = j(), t.exports = s;
})), N = /* @__PURE__ */ b((/* @__PURE__ */ v(((e, t) => {
	t.exports = M(), t.exports.SqliteError = C();
})))(), 1), P = u(import.meta.url)("xlsx"), F = c.dirname(s(import.meta.url)), I = new N.default(n.isPackaged ? c.join(n.getPath("userData"), "inventory.db") : c.join(F, "../", "Database", "inventory.db"));
...
function K(e) {
	let t = c.basename(e), r = n.isPackaged ? c.join(n.getPath("userData"), "images", "product-images") : c.join(F, "../", "Database", "images", "product-images"), i = c.join(r, t);
	return l.existsSync(r) || l.mkdirSync(r, { recursive: !0 }), l.existsSync(i) || l.copyFileSync(e, i), `images/product-images/${t}`;
}
function q(e) {
	if (!e) return null;
	let t = n.isPackaged ? n.getPath("userData") : c.join(F, "../", "Database");
	return c.join(t, e);
}
function J(e) {
...
function ce(e) {
	...
	for (let e of n) {
		let t = e[0];
		!p || t !== u ? (p && l.push([u, f]), u = t, f = [e], p = !0) : f.push(e);
	}
	p && l.push([u, f]);
	let m = {};
	for (let [e, t] of l) {
	...
	return I.transaction(() => {
		for (let [e, t] of Object.entries(m)) {
			...
			r ? i = r.id : (i = d(), I.prepare("INSERT INTO products (id, name, images) VALUES (?, ?, ?)").run(i, e, ""));
			let a = {};
			for (let e of n) {
...
var Q = c.dirname(s(import.meta.url));
function $() {
	let e = new t({
		width: 1200,
		height: 800,
		webPreferences: { preload: c.join(Q, "preload.cjs") }
	});
	process.env.VITE_DEV_SERVER_URL ? e.loadURL(process.env.VITE_DEV_SERVER_URL) : e.loadFile(c.join(Q, "../dist/index.html"));
}
o.registerSchemesAsPrivileged([{
	...
	o.handle("app-image", (e) => {
		...
		return a.fetch(`file:///${t}`);
	}), i.handle("db:addProduct", (e, t) => L(t)), i.handle("db:getProducts", () => R()), i.handle("db:deleteProduct", (e, t) => z(t)), i.handle("db:editProduct", (e, t, n) => B(t, n)), i.handle("db:getProductByName", (e, t) => V(t)), i.handle("db:getVariantBySize", (e, t, n) => re(t, n)), i.handle("db:addVariant", (e, t, n) => H(t, n)), i.handle("db:addBase", (e, t, n) => U(t, n)), i.handle("db:addBaseStock", (e, t, n, r) => G(t, n, r)), i.handle("db:getBaseByName", (e, t, n) => W(t, n)), i.handle("db:addCustomer", (e, t) => J(t)), i.handle("db:addBill", (e, t, n) => Y(t, n)), i.handle("db:editCustomer", (e, t, n) => oe(t, n)), i.handle("db:editBill", (e, t, n) => se(t, n)), i.handle("db:getCustomers", () => X()), i.handle("db:deleteCustomer", (e, t) => ie(t)), i.handle("db:deleteBill", (e, t) => ae(t)), i.handle("db:resolveImagePath", (e, t) => q(t)), i.handle("dialog:pickExcelFile", async () => {
	...
	}), i.handle("db:importExcel", (e, t) => ce(t)), i.handle("db:copyImage", (e, t) => K(t)), i.handle("dialog:pickImage", async () => {
		let e = await r.showOpenDialog({
			properties: ["openFile"],
			filters: [{
				name: "Images",
